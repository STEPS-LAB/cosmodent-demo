...
export function HeroSection() {
  ...
  return (
    <section className="relative bg-gradient-to-br from-primary-50 via-white to-primary-100/50 overflow-hidden min-h-[85vh] sm:min-h-[90vh] flex items-center">
      {/* Animated background decoration */}
      <div className="absolute inset-0 overflow-hidden">
        {/* Large gradient orbs */}
        <div className="absolute -top-20 -right-20 sm:-top-40 sm:-right-40 w-64 h-64 sm:w-96 sm:h-96 bg-gradient-to-br from-primary-200 to-primary-300 rounded-full opacity-60 blur-3xl float animate-pulse-slow" />
        <div className="absolute -bottom-20 -left-20 sm:-bottom-40 sm:-left-40 w-64 h-64 sm:w-96 sm:h-96 bg-gradient-to-tr from-primary-200 to-primary-300 rounded-full opacity-60 blur-3xl float-delayed animate-pulse-slow" />

        {/* Additional decorative elements */}
        <div className="absolute top-1/4 left-1/4 w-48 h-48 sm:w-64 sm:h-64 bg-gradient-to-br from-primary-100 to-transparent rounded-full opacity-40 blur-2xl float" style={{ animationDelay: '1s' }} />
        <div className="absolute bottom-1/4 right-1/4 w-48 h-48 sm:w-64 sm:h-64 bg-gradient-to-tl from-primary-100 to-transparent rounded-full opacity-40 blur-2xl float-delayed" style={{ animationDelay: '2s' }} />
      ...
      <div className="container-custom relative py-16 sm:py-20 md:py-32 z-10">
        <div className="max-w-4xl">
          ...
          {/* Trust indicators */}
          <div className={`grid grid-cols-3 gap-4 sm:gap-6 md:gap-12 animate-fade-in-up ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`} style={{ transitionDelay: '400ms' }}>
            <div className="group">
              <div className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-gradient-primary bg-gradient-to-r from-primary-600 to-primary-500 bg-clip-text text-transparent group-hover:scale-110 transition-transform duration-300">15+</div>
              <div className="text-xs sm:text-sm md:text-base text-secondary-600 mt-1 sm:mt-2 font-medium">Років досвіду</div>
            </div>
            <div className="group">
              <div className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-gradient-primary bg-gradient-to-r from-primary-600 to-primary-500 bg-clip-text text-transparent group-hover:scale-110 transition-transform duration-300">5000+</div>
              <div className="text-xs sm:text-sm md:text-base text-secondary-600 mt-1 sm:mt-2 font-medium">Задоволених пацієнтів</div>
            </div>
            <div className="group">
              <div className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-gradient-primary bg-gradient-to-r from-primary-600 to-primary-500 bg-clip-text text-transparent group-hover:scale-110 transition-transform duration-300">20+</div>
