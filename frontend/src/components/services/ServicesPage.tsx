          ...
          {loading
            ...
            : filteredServices.map((service) => (
                <Link
                  ...
                  className="card p-6 group hover:border-primary-200 transition-all duration-300 block"
                >
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    ...
                    <div className="flex items-center gap-4">
                      <div className="text-right">
                        <div className="text-sm text-secondary-500">вартість від</div>
                        <div className="text-xl font-bold text-primary-600">
                          {service.startingPrice.toLocaleString()} ₴
                        </div>
                      </div>
                      <span className="text-primary-600 group-hover:translate-x-2 transition-transform text-2xl">
                        →
                      </span>
                    </div>
                  </div>
