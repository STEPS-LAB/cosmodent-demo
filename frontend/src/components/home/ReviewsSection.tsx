...
export function ReviewsSection() {
  ...
  return (
    <section ref={sectionRef} className="py-16 sm:py-20 md:py-28 bg-gradient-to-b from-white via-primary-50/20 to-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-20 left-4 sm:left-10 text-6xl sm:text-9xl font-serif text-primary-100/40 select-none">&quot;</div>
        <div className="absolute bottom-20 right-4 sm:right-10 text-6xl sm:text-9xl font-serif text-primary-100/40 select-none">&quot;</div>
      </div>
      ...
      <div className="container-custom relative z-10">
        ...
        <div className="text-center mb-12 sm:mb-16">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 sm:px-4 sm:py-2 bg-amber-50 border border-amber-200 rounded-full mb-6 animate-fade-in-up">
            ...
            <span className="text-xs sm:text-sm font-semibold text-amber-700 uppercase tracking-wide">Відгуки пацієнтів</span>
          </div>
          <h2 className="section-title text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-center">Що кажуть наші пацієнти</h2>
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center gap-6 sm:gap-12 mb-12 sm:mb-16 animate-fade-in-up">
          <div className="relative group">
            ...
            <div className="relative bg-white/80 backdrop-blur-xl border border-amber-200/50 rounded-3xl p-6 sm:p-8 shadow-xl shadow-amber-500/10">
              ...
              <div className="text-3xl sm:text-4xl font-bold bg-gradient-to-r from-amber-600 to-amber-500 bg-clip-text text-transparent">{stats.averageRating}/5</div>
          ...
          <div className="relative group">
            ...
            <div className="relative bg-white/80 backdrop-blur-xl border border-primary-200/50 rounded-3xl p-6 sm:p-8 shadow-xl shadow-primary-500/10">
              <div className="text-3xl sm:text-4xl font-bold bg-gradient-to-r from-primary-600 to-primary-500 bg-clip-text text-transparent mb-1">{stats.activeReviews}</div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          {loading
            ...
            : reviews.map((review, index) => (
                ...
                >
                  {/* Quote icon */}
                  <div className="absolute top-4 right-4 sm:top-6 sm:right-6 text-4xl sm:text-5xl font-serif text-primary-200/50 select-none group-hover:text-primary-300/70 transition-colors duration-500">&quot;</div>
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-secondary-100 group-hover:border-primary-200 transition-colors duration-300">
                    <div className="flex items-center gap-2 sm:gap-3">
                      ...
                      <div>
                        <div className="text-xs sm:text-sm font-semibold text-secondary-900">{review.patientName}</div>
        ...
        <div className="text-center mt-12 sm:mt-16">
          <a href="/reviews" className="btn-outline inline-flex items-center gap-2 group w-full sm:w-auto justify-center">
